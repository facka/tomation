...
- [x] 1. Implement search filter in Home view
  - [x] 1.1 Add search input and filter logic to Home view in `packages/extension/src/panel.js`
  ...
  - [x] 1.2 Clear search on view navigation in `packages/extension/src/panel.js`
